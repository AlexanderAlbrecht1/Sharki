const level1 = new Level(
    enemies = [
        new pufferFish(500,0),
        new pufferFish(750,1),
        new pufferFish((1000 + Math.random() * 1600),2),
        new pufferFish((1000 + Math.random() * 1600),3),
        new pufferFish((2000 + Math.random() * 200),4),
        new pufferFish((2000 + Math.random() * 200),5),
        new pufferFish((2),6),
        new pufferFish((2),7),
        new pufferFish((2),8),
